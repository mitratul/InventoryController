/*
 * JDialogReportMaterialCostSheet.java
 *
 ...
 * @author  brinto
 */
public class JDialogReportMaterialCostSheet extends javax.swing.JDialog {
    
    /** Creates new form JDialogReportMaterialCostSheet */
    public JDialogReportMaterialCostSheet(inventorycontroller.display.JFrameMDI parent, boolean modal, 
    ...
    private void initComponents(inventorycontroller.display.JFrameMDI parent, 
     inventorycontroller.function.DbInterface dbi) {
        ...
        jLabel3.setText("Jobs Ended Between");
    ...
    public void dateChanged(){
    	...
    	fillJobTable(sDate, eDate);
    }
    
    public void fillJobTable(String sDate, String eDate){
    ...
    private void createReport(){
    	...
    	inventorycontroller.function.MaterialCostSheetReportProcessor rp=
    	 new inventorycontroller.function.MaterialCostSheetReportProcessor(
    	 	dbInterface1, jbNos
    	 );
    	rp.generate();
