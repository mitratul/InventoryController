 ...
 * @author  brinto
 */
public class JDialogReportBOM extends javax.swing.JDialog {
    
    /** Creates new form JDialogReportGRN */
    public JDialogReportBOM(inventorycontroller.display.JFrameMDI parent, boolean modal, 
    ...
    private void initComponents(inventorycontroller.display.JFrameMDI parent, 
     inventorycontroller.function.DbInterface dbi) {
    	...
    	bomList=null;
    	selectedBomList=new java.util.Vector<String>();
        ...
        jLabel1.setText("Select Bill Of Material:");
    ...
    private void generatePerform(){
    	...
    	for (int i = 0; i<tm.getRowCount(); i++){
    		if((Boolean)tm.getValueAt(i, 0)){
    			selectedBomList.add(new String(tm.getValueAt(i, 1).toString()));
    		}
    	}
    ...
    private void createReport(){
    	String[] bomNos=new String[selectedBomList.size()];
    	for (int i = 0; i<bomNos.length; i++){
    		bomNos[i]=selectedBomList.elementAt(i);
    	}
    	inventorycontroller.function.BillOfMaterialReportProcessor grp=
    	 new inventorycontroller.function.BillOfMaterialReportProcessor(dbInterface1, bomNos);
    	grp.generate();
    ...
    private java.util.Vector<String> selectedBomList;
