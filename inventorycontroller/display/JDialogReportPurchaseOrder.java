/*
 * JDialogReportPurchaseOrder.java
 *
 ...
 * @author  brinto
 */
public class JDialogReportPurchaseOrder extends javax.swing.JDialog {
    
    /** Creates new form JDialogReportGRN */
    public JDialogReportPurchaseOrder(inventorycontroller.display.JFrameMDI parent, boolean modal, 
    ...
    private void initComponents(inventorycontroller.display.JFrameMDI parent, 
     inventorycontroller.function.DbInterface dbi) {
        ...
        jLabel1.setText("Select Purchase Order:");
    ...
    private void createReport(){
    	...
    	inventorycontroller.function.PurchaseOrderReportProcessor rp=
    	 new inventorycontroller.function.PurchaseOrderReportProcessor(dbInterface1, poNos);
    	rp.generate();
